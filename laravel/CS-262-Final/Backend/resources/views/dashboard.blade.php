@php
    ...
    $bank = \DB::table('banks')->get()->count();
    $loan = \DB::table('loan_packages')->get()->count();
    $admin = \DB::table('admins')->get()->count();
@endphp
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        <p class="text-truncate font-size-14 mb-2">Banks</p>
                        <h4 class="mb-2">{{ $bank }}</h4>
                        <p class="text-muted mb-0"><span class="text-success fw-bold font-size-12 me-2"><i
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        <p class="text-truncate font-size-14 mb-2">Loans</p>
                        <h4 class="mb-2">{{ $loan }}</h4>
