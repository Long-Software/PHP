            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto text-center">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a href="/lenders" class="dropdown-item">Lenders</a></li>
                            <li><a href="/user/loan_listing" class="dropdown-item">Available Loan</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a href="/loan/history" class="dropdown-item">Loan History</a></li>
                            <li><a href="/calculator" class="dropdown-item">Calculator</a></li>
                        </ul>
                    </li>
