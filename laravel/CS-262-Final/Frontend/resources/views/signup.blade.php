                        ...
                        <div class="wrapper">
                            <div class="wrapper-content pin-side40">
                                <div class="signup-block">
                                    ...
                                    <form class="form-horizontal signup_form" action="register" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control input-sm" id="user_username"
