        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <form class="form-horizontal mt-3" method="POST" action="/register" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" required="" placeholder="Password">
                                </div>
                            </div>
                            <div class="form-group mb-3 row">
                                <div class="col-12">
